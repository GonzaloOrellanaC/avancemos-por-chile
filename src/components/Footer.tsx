        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/firmas" className="text-gray-300 hover:text-white transition-colors">Firmas de Iniciativas</Link></li>
              <li><Link to="/firmas/datos" className="text-gray-300 hover:text-white transition-colors">Datos de las firmas</Link></li>
