...
import { getPosts, getMyPosts, getReviewQueue, createPost, updatePost, deletePost, getPostById, getPostsByAuthor, getPostBySlug, incrementBlogPageView, incrementPostView } from '../controllers/postController.ts';
...
router.get('/blog/view', incrementBlogPageView);
